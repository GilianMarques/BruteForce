...
class Rotor(
    ...
    // É true quando o rotor muda do último para o primeiro caractere, depois volta a ser false.
    var hasReset = false
        private set

    /* A ideia é que o índice seja definido como 0 no loop principal, o que pode não acontecer quando
       o algoritmo for executado com mais de um rotor. Nesse caso, a variável "initialized" indicará à função
